...
if ( ! function_exists( 'fptonline_pagination' ) ) {
    function fptonline_pagination() {
        ...
        <?php if ( get_next_post_link() ) : ?>ádasd
...
function fptonline_readmore() {
    echo '...<a class="read-more" href="'. get_permalink( get_the_ID() ) . '">' . __('Read More', 'fptonline') . '</a>';
}
...
if ( ! function_exists( 'get_post_homepage' ) ) {
    function fptonline_get_post_homepage()
    { echo 'nguyen Anh tuan';
        /*$args_my_query = array(
            'post_type' => 'post',
            'orderby' => 'DESC',
            'posts_per_page' => 2
        ...
        return $my_query_post;*/
    }
}

/** End tuanna adđ function */